...
const withPWA = require("next-pwa")({
  ...
  register: true,
  skipWaiting: true,
  // Disable PWA in development to avoid navigation issues
  disable: process.env.NODE_ENV === 'development',
  buildExcludes: [/middleware-manifest\.json$/],
  // Important: Configure runtime caching to avoid blocking authentication flows
  runtimeCaching: [
    {
        ...
        headers: [
          {
            ...
            value: process.env.NEXTAUTH_URL || 'https://healthy-app-pwa.vercel.app',
          },
          {
